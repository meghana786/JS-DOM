...
var elements2 = document.querySelectorAll('.dom-methods');
for (let i = 0; i < elements2.length; i++) {
  elements2[i].style.fontSize = '20px';
}
...
var textContent = document.getElementById('main');
textContent.innerHTML = 'This is a division';
...
// Select the element with the class "footer"
...
copyrightDiv.remove();
// Select the element with the class "copyright"
